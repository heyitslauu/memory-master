...
function Card({cardCharacters, cardClick}){
	return (
            ...
            cardCharacters.map((char) => {
              return (
                <div key={char.id} 
									className='cursor-pointer px-4 py-4 rounded-lg transition ease-out delay-100 hover:shadow-md hover:shadow-yellow-100' 
									style={{ backgroundColor: 'rgba(200, 100, 150, 0.4)'}} 
